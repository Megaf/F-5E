...
var fuelTanks = func {
	...
	var levelDropStbd = getprop("consumables/fuel/tank[5]/level-gal_us");
		...
		var levelDropCentr = getprop("consumables/fuel/tank[4]/level-gal_us");
		if(levelDropCentr == nil) { levelDropCentr = 0; }
		var wingtanks = getprop("sim/weight[2]/weight-lb") + getprop("sim/weight[4]/weight-lb");
		var centertank = getprop("sim/weight[3]/weight-lb");
